...
function toggleLoading(isLoading) {
  ...
  var nodeI = document.querySelector("#search > button > i");
  var nodeSpan = document.querySelector("#search > button > span");
  var span = document.createElement("span");
  var TextNodeLoading = document.createTextNode(" Loading...");
  var TextNodeSearch = document.createTextNode(" Search");
  if (isLoading){
    nodeI.className = "fa fa-hourglass-half";
    span.appendChild(TextNodeLoading);
    nodeSpan.replaceWith(span);
    document.querySelector("#search > button").disabled = true;
  } else {
    nodeI.className = "fa fa-search";
    span.appendChild(TextNodeSearch);
    nodeSpan.replaceWith(span);
